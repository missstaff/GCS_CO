...
namespace GCS_CO.Controllers.Admin
{
    ...
    public class SkillsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SkillId,SkillName,SkillDescription,SkillPayRate")] Skill skill)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SkillId,SkillName,SkillDescription,SkillPayRate")] Skill skill)
        {
            if (id != skill.SkillId)
            {
                return NotFound();
